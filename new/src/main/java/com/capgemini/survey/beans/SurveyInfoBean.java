...
public class SurveyInfoBean implements Serializable {
	private static final long serialVersionUID = 6476998111990900389L;
	...
	public String toString() {
		String str = "\n";
		return "surveyTitle = " + surveyTitle + str + "surveyDescription = " + surveyDescription + str + surveyQuestion1
				+ str + surveyQuestion2 + str + surveyQuestion3 + str + surveyQuestion4 + str + surveyQuestion5 + str
				+ surveyQuestion6 + str + surveyQuestion7 + str + surveyQuestion8 + str + surveyQuestion9 + str
				+ surveyQuestion10 + str + str;
	}
